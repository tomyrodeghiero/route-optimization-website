  ...
  return (
    <section className="bg-hero bg-no-repeat bg-left-top min-h-[800px] lg:min-h-[950px] lg:mb-80">
      ...
      >
        ...
        <motion.h1
          variants={fadeInDown}
          className="h1 max-w-[870px] mb-10 text-white pt-[12rem] bg-[60px]"
        >
          {title}
        </motion.h1>
        {/* button */}
        ...
        >
          <Image alt="Image" src={girlImg} width={206} height={495} />
        </motion.div>
        {/* truck image */}
        <motion.div
        ...
        >
          <Image src={truckImg} alt="Image" width={811} height={395} />
        </motion.div>
        {/* boy image */}
        <motion.div
          variants={boyAnim}
        ...
        >
          <Image src={boyImg} alt="Image" width={206} height={495} />
        </motion.div>
      </motion.div>
    </section>
  );
