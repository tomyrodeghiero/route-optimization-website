...
const Footer = ({ footerData }) => {
  ...
  return (
    <footer className="bg-darkblu lg:bg-transparent lg:bg-footer lg: bg-no-repeat lg:bg-left-bottom lg:min-h-[738px] pt-12 lg:pt-0 relative">
      <motion.div
      ...
      >
        ...
        >
          <Image src={truckImg} alt="Image" width={430} height={210} />
        </motion.div>
        {/* hill image */}
        <div className="hidden lg:flex absolute z-10 top-[22px] left-0">
          <Image src={hillImg} alt="Image" width={137} height={92}></Image>
        </div>
        {/*text & form */}
        <motion.div
          variants={fadeInUp}
        ...
        >
          ...
          <div className="mb-6 mx-auto lg:mb-0 lg:mx-0">
            <Link href={"/"}>
              <a>{/* <Image src={logo} width={170} height={41} /> */}</a>
            </Link>
          </div>
          {/* links */}
